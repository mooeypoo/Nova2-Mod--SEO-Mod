...
<?php /*		<li><a href="#three"><span><?php echo $label['seo_header_three'];?></span></a></li>*/ ?>
	...
	<div id="four">
		<?php echo form_open('seo/index/robots');?>
			...
			<p>For more information about Robots file, <a href="http://www.robotstxt.org/robotstxt.html" target="_blank">click here</a>.</p>
			<p>COMING SOON.</p>
<?php
/*			<p>
				<kbd>Robots File</kbd>
				<textarea name="seo_robots" id="seo_robots" cols=50 rows=5><?php echo $data['seo_robots']; ?></textarea>
			</p>
				<p><?php echo form_button($buttons['add']);?></p>
*/
?>
